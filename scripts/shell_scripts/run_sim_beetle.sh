...
BASE_OUTPUT_DIR="/mnt/nfs2/bioenv/sg802/hybrid_sim_project/simulation_outputs_linked_closed/"
ANALYSIS_OUTPUT_FILE="${BASE_OUTPUT_DIR}/combined_matching_generations_linked_closed.csv"
...
for ((i=$1; i<=$2; i++)); do
    ...
    SIM_COMMAND="$VENV_PYTHON_EXE -u $SIM_SCRIPT --output_dir $REPLICATE_DIR --replicate_id $i --file "/mnt/nfs2/bioenv/sg802/hybrid_sim_project/beetle_input.csv" -npa 100 -npb 100 -HG 3000 -nc 1 -oh -gmap"
